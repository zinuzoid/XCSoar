                            ...
                            [[maybe_unused]] const PixelRect &rc) noexcept
{
  ...
  AddBoolean(_("Vario traffic"), _("Show traffic in different colours depending on climb rate and relative altitude."),
             settings_map.use_vario_traffic_colours);
  SetExpertRow(VARIO_TRAFFIC);
...
SymbolsConfigPanel::Save(bool &_changed) noexcept
{
  ...
  changed |= SaveValue(VARIO_TRAFFIC, ProfileKeys::VarioTraffic,
                       settings_map.use_vario_traffic_colours);
