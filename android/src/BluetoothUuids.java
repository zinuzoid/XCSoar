...
public interface BluetoothUuids {
  ...
  /* Environmental Sensing - Bluetooth SIG standard */
  UUID ENVIRONMENTAL_SENSING_SERVICE =
    UUID.fromString("0000181A-0000-1000-8000-00805F9B34FB");
  UUID WIND_SPEED_CHARACTERISTIC =
    UUID.fromString("00002A70-0000-1000-8000-00805F9B34FB");
  UUID WIND_DIRECTION_CHARACTERISTIC =
    UUID.fromString("00002A71-0000-1000-8000-00805F9B34FB");
  UUID STATIC_PRESSURE_CHARACTERISTIC =
    UUID.fromString("00002A6D-0000-1000-8000-00805F9B34FB");
  UUID AIR_TEMPERATURE_CHARACTERISTIC =
