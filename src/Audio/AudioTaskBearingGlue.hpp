...
#ifndef XCSOAR_AUDIO_TASK_BEARING_GLUE_HPP
#define XCSOAR_AUDIO_TASK_BEARING_GLUE_HPP

#include "Features.hpp"

struct VarioSoundSettings;

namespace AudioTaskBearingGlue {
  ...
  static inline void Configure(const VarioSoundSettings &) {}
  static inline void SetValue(double) {}
