...
AudioTaskBearingConfigPanel::Save(bool &changed) noexcept
{
  ...
  if (SaveValue(Volume, ProfileKeys::AudioTaskBearingVolume, volume)) {
  ...
  changed |= SaveValue(MIN_FREQUENCY, ProfileKeys::AudioTaskBearingMinFrequency,
                       settings.min_frequency);

  changed |= SaveValue(ZERO_FREQUENCY, ProfileKeys::AudioTaskBearingZeroFrequency,
                       settings.zero_frequency);

  changed |= SaveValue(MAX_FREQUENCY, ProfileKeys::AudioTaskBearingMaxFrequency,
