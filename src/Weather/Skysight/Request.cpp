...
#include "net/http/Slist.hxx"

void
SkysightRequest::FileHandler::OnData(ConstBuffer<void> data)
{
...
void
SkysightRequest::FileHandler::Wait() noexcept {
...
void
SkysightRequest::BufferHandler::OnData(ConstBuffer<void> data)
{
...
void
SkysightRequest::BufferHandler::Wait() noexcept {
  std::unique_lock<Mutex> lock(mutex);
  cond.wait(lock, [this]{ return done; });
