...
bool
Skysight::IsReady(bool force_update)
{
...
void
Skysight::APIInited(const tstring details, const bool success,
...
void
Skysight::DownloadComplete(const tstring details, const bool success,
                const tstring layer_id, const uint64_t time_index)
{
  if (!self)
    return;
