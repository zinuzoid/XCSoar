...
/**
 * Look for the winds.mobi wind station map overlay, drawn via
 * #WindBarbRenderer: one pen+brush #Band per gust-strength band, plus
 * a desaturated set for stale measurements, and the font used for the
 * avg/gust label drawn alongside each barb.
 */
struct WindBarbLook {
  /**
