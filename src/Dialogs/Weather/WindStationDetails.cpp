 ...
 * is no live update: the wind feed is polled about once a minute, and
...
class WindStationDetailsWidget final : public RowFormWidget {
  ...
  const JETProvider::WindStation station;

public:
  explicit WindStationDetailsWidget(const JETProvider::WindStation &_station) noexcept
